...
const SalesSummaryCard = (props: Props) => {
  ...
  const averageChangePercentage =
    salesData.reduce(
      (acc, curr, _, arr) => acc + curr.changePercentage! / arr.length,
      0
    ) || 0;
  ...
  return (
    <div className="row-span-3 xl:row-span-6  bg-white shadow-md rounded-2xl pb-8 overflow-scroll">
      {isLoading ? (
